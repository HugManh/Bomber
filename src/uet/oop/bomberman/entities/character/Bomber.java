...
public class Bomber extends Character {
    ...
    {
        File die = new File("C:\\Users\\think\\Documents\\game\\bom\\res\\sounds\\creaming.wav");
        Sound whenDieMusic = TinySound.loadSound(die);
        whenDieMusic.play();
    }
  ...
  //Từ 148- 200  
    ...
    public boolean canMove(double x, double y) {
        ...
        for (int c = 0; c < 4; c++) { //kiểm tra xung đột quanh người chơi
            double xt = ((_x + x) + c % 2 * 11) / Game.TILES_SIZE; //chuyển sang tọa độ các ô
